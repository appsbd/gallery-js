<template :options="{
        ...
        <div class="apbd-image-gallery-container" :class="gallery_options.gallery_style" ref="container">
          <div class="apbd-gallery">
            <div class="apbd-img-container" v-if="gallery_options.type == 'image'"
              v-for="image in gallery_options?.images">
              <a data-fancybox="gallery" :href="image">
                <img :src="image" />
              </a>
            </div>
            <div class="apbd-img-container" v-if="gallery_options.type == 'video'"
              v-for="video in gallery_options?.videos">
